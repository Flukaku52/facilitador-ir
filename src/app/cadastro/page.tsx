...
function CadastroForm() {
 ...
 >
 Nome <span className="text-muted font-normal">(opcional)</span>
 </label>
 <input
 id="name"
 type="text"
 ...
 className="w-full rounded-lg border border-border px-3 py-2.5 text-foreground placeholder-muted focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-slate-800 dark:placeholder-muted"
 ...
 className="w-full rounded-lg border border-border px-3 py-2.5 pr-10 text-foreground placeholder-muted focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-slate-800 dark:placeholder-muted"
 placeholder="Mínimo 8 caracteres"
 />
 <button
 type="button"
 onClick={() => setShowPassword((v) => !v)}
 className="absolute inset-y-0 right-0 flex items-center pr-3 text-muted hover:text-body dark:hover:text-foreground"
