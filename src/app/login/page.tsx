...
function LoginForm() {
  ...
  const [error, setError] = useState(
    params.get('error') === 'callback' ? 'O link de confirmação expirou ou é inválido. Tente entrar novamente.' : '',
  );
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-16">
      <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">Entrar</h1>
