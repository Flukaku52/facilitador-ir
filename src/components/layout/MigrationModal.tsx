...
export default function MigrationModal({ open, cloudProfile, onMigrate, onDiscard, onCancel }: Props) {
 ...
 disabled={submitting !== null}
 className="flex w-full flex-col rounded-lg border border-border bg-background p-3 text-left hover:bg-slate-100 disabled:opacity-60 transition-colors dark:bg-slate-800 dark:hover:bg-slate-700"
 >
 ...
 onClick={onCancel}
 disabled={submitting !== null}
 className="w-full rounded-lg border border-border bg-surface p-3 text-sm font-medium text-body hover:bg-background disabled:opacity-60 transition-colors dark:text-muted dark:hover:bg-slate-800"
 >
 Decidir depois
 </button>
 </div>
