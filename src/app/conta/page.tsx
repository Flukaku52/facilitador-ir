...
function ChangePasswordForm({ onCancel }: { onCancel: () => void }) {
 ...
 className="w-full rounded-lg border border-border px-3 py-2 text-sm text-foreground placeholder-muted focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-slate-800"
 ...
 type="button"
 onClick={onCancel}
 className="rounded-lg border border-border px-4 py-2 text-sm text-body hover:bg-background transition-colors dark:text-muted dark:hover:bg-slate-800"
 >
 Cancelar
 </button>
 </div>
...
function DeleteModal({
 ...
 <button
 onClick={onClose}
 className="flex-1 rounded-lg border border-border py-2 text-sm text-body hover:bg-background transition-colors dark:text-muted dark:hover:bg-slate-800"
 >
 Cancelar
 </button>
 </div>
 ...
 className="mt-3 w-full rounded-lg border border-border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-danger-500 dark:bg-slate-800 dark:text-foreground"
 placeholder="excluir"
 />
 ...
 onClick={onClose}
 disabled={deleting}
 className="flex-1 rounded-lg border border-border py-2 text-sm text-body hover:bg-background disabled:opacity-60 transition-colors dark:text-muted dark:hover:bg-slate-800"
 >
 Cancelar
 </button>
 </div>
...
export default function ContaPage() {
 ...
 <div className="h-8 w-48 rounded bg-slate-200 animate-pulse dark:bg-slate-700" />
 </div>
 );
 }
 ...
 className="shrink-0 rounded-lg border border-border px-3 py-1.5 text-sm font-medium text-body hover:border-primary-400 hover:text-primary-600 transition-colors dark:hover:border-primary-500 dark:hover:text-primary-400"
 >
 Alterar senha
 </button>
 )}
