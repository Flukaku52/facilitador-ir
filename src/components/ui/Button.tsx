...
const variantClasses: Record<Variant, string> = {
  ...
  secondary:
    'bg-surface text-primary-600 border border-primary-600 hover:bg-primary-50 active:bg-primary-100 disabled:opacity-50 dark:text-primary-400 dark:border-primary-500 dark:hover:bg-gray-800',
  ghost:
...
export default function Button({
  ...
  return (
    <button
      className={[
        'inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 disabled:cursor-not-allowed dark:focus:ring-offset-gray-900',
