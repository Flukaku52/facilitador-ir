...
export default function UserMenu() {
 ...
 if (loading) {
 return <div className="h-8 w-8 rounded-full bg-slate-200 animate-pulse dark:bg-slate-700" />;
 }
 ...
 <Link
 href="/login"
 className="rounded-lg border border-border px-3 py-1.5 text-sm font-medium text-body hover:border-primary-400 hover:text-primary-600 transition-colors dark:hover:border-primary-500 dark:hover:text-primary-400"
 >
 Entrar
 </Link>
 );
 ...
 <div className="border-b border-border/50 px-4 py-3 dark:border-border">
 ...
 className="flex w-full items-center rounded-lg px-3 py-2 text-sm text-body hover:bg-slate-100 transition-colors dark:hover:bg-slate-800"
 >
 Minha conta
 </Link>
