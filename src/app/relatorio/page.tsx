...
function ReportContent() {
 ...
 className="rounded-lg border border-border px-4 py-2 text-sm font-medium text-body hover:bg-background transition-colors dark:hover:bg-slate-800"
 >
 Cancelar
 </button>
 <button
 ...
 <li
 key={item.id}
 className={`flex items-start gap-2 ${item.completed ? "text-muted" : "text-body"}`}
 >
 <span
 className={
 item.completed
 ...
 className="text-primary-600 hover:underline dark:text-primary-400 print:text-body"
 >
 {guide.title}
 </Link>
 </li>
