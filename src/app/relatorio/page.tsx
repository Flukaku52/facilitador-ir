  ...
  if (!profile) {
    return (
      <div className="mx-auto max-w-xl px-4 py-20 text-center">
        ...
        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Responda as perguntas para gerar seu relatório personalizado com checklist, guias e alertas.</p>
